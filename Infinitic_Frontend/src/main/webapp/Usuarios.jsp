...
<body>
    ...
    <nav class="nav container">
      ...
      <input maxlength="12" type="text" name="txtcedula" class="update_input" id="id_editar" placeholder="Cédula" readonly="readonly" required
		title="Este campo es obligatorio" required pattern="[0-9]+" value="${usuarioSeleccionado.getCedula_usuario()}">		
	  </div>
	  
	  
	  <div class="form_update">
       <input maxlength="50" maxlength="50" type="text" name="txtnombre" id="nombre" class="update_input" placeholder="Nombre"  required
		title="Este campo es obligatorio" required pattern="[a-zA-Z]+" value="${usuarioSeleccionado.getNombre_usuario()}">          
      </div>
		 
		  <div class="form_update">
        <input type="text" name="txtemail" id="email" class="update_input" placeholder="@email" required
		 title="Este campo es obligatorio"value="${usuarioSeleccionado.getEmail_usuario()}">
      </div>
      
      <div class="form_update">
        <input maxlength="50" type="text" name="txtusuario" id="usuario" class="update_input" placeholder="Usuario" required
		 title="Este campo es obligatorio" required pattern="[a-zA-Z0-9]+" value="${usuarioSeleccionado.getUsuario()}">      
      </div>
      
      <div class="form_update"> 
          <input maxlength="20" type="text" name="txtpassword" id="password" class="update_input" placeholder="Contraseña" required
          title="Este campo es obligatorio" required pattern="[a-zA-Z0-9]+"value="${usuarioSeleccionado.getPassword()}">   
        </div>
      ...
      <div class="botones_update">  
      <a href="Controlador?menu=Usuarios&accion=Listar">
  ...
  <form class="formulario_registro" method="get" action="Controlador">
      <div class="formulario_titulo">USUARIOS</div>
      ...
      <div class="form_div">
        <i class="formulario_icono fas fa-user"></i>
        <input maxlength="50" type="text" name="txtusuario" class="formulario_input" placeholder="Usuario..." title="Este campo es obligatorio" required pattern="[a-zA-Z0-9]+">      
      </div>
     

      <div class="form_div"> 
          
        <i class="formulario_icono fas fa-lock"></i>      
          <input type="password" name="txtpassword" class="formulario_input"  placeholder="Contraseña...">   
        </div>
